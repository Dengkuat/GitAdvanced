...
```bash
     DENGKUAT@MacBookPro GitAdvanced % git rebase -i --root       
    [detached HEAD 5258535] Create Third File
    Date: Mon Sep 8 21:33:10 2025 +0200
    2 files changed, 0 insertions(+), 0 deletions(-)
    create mode 100644 test3.md
    create mode 100644 test4.md
    Successfully rebased and updated refs/heads/main.
    ...
    Stopped at 5258535...  Create Third File
    You can amend the commit now, with
    ...
    git rebase --continue
    DENGKUAT@MacBookPro GitAdvanced % git commit --amend -m "Create third and fourth files"
    [detached HEAD 128ee9b] Create third and fourth files
    Date: Mon Sep 8 21:33:10 2025 +0200
    2 files changed, 0 insertions(+), 0 deletions(-)
    create mode 100644 test3.md
    create mode 100644 test4.md
